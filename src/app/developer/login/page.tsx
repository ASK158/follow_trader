...
export const metadata: Metadata = { title: "用户登录 | Sigma Signal", description: "登录或注册账户，上架交易工具并参与商品评论。" };
...
export default async function DeveloperLoginPage({ searchParams }: Props) {
  ...
  return (
    <main className="platform-shell developer-shell">
      ...
      <footer className="platform-footer">上架即表示你确认拥有所提交源码的完整权利；平台保留对违规作品下架的权利。</footer>
    </main>
  );
}
