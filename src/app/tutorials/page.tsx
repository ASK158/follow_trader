...
export const metadata: Metadata = { title: "量化交易教程 | Sigma Signal", description: "MT5、MQL5、策略设计、风险管理与量化交易图文及视频教程。" };
...
export default function TutorialsPage() {
  ...
  return (
    <main className="platform-shell tutorials-shell">
      ...
      <footer className="platform-footer">外部视频归相应平台及创作者所有；链接仅用于帮助用户发现公开学习资源。</footer>
    </main>
  );
}
