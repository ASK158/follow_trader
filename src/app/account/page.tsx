...
export default async function AccountPage() {
  ...
  return <main className="platform-shell developer-shell"><SiteNav active="developer" /><div className="platform-breadcrumb"><Link href="/developer">← 返回个人中心</Link><span>ACCOUNT SECURITY</span></div><header className="dev-form-header"><span className="panel-code">ACCOUNT & SECURITY</span><h1>账户与安全</h1><p>Gas 余额：<b>{formatGa(user.gaBalance)}</b>。管理个人资料、密码、二次验证和登录设备。</p></header><AccountSettings user={user} sessions={sessions} /></main>;
}
